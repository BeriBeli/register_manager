...
const getSessionUser = (session: SessionData | null | undefined): SessionUser | null => {
...
const isApprovedUser = (user: SessionUser | null): boolean => user?.approved === true;

const isAdminUser = (user: SessionUser | null): boolean => user?.role === "admin";
...
function PublicRoute({ children }: { children: React.ReactNode }) {
    ...
    if (session && isApprovedUser(user)) {
